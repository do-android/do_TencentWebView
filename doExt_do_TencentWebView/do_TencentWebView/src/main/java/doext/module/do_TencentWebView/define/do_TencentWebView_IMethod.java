 ...
 * 声明自定义扩展组件方法
 */
public interface do_TencentWebView_IMethod {
	...
	void eval(JSONObject _dictParas,DoIScriptEngine _scriptEngine, String _callbackFuncName) throws Exception ;
	...
	void setDefaultEncodingURL(JSONObject _dictParas,DoIScriptEngine _scriptEngine, DoInvokeResult _invokeResult) throws Exception ;
